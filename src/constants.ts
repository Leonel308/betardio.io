...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  '7WvNdmN89YhbP65NRvJP8DMcc3rLpmWjPXhjftuK6QKR',
)
...
// Creator fee (in %)
export const PLATFORM_CREATOR_FEE = 0.05 // 5% (1/100 = 0.01)

// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.001 // 1.0% (0.1/100 = 0.001)
